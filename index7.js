...
function addItem(e){
  ...
  var newItemdes = document.getElementById('itemdes').value;
  ...
  let nItem=document.createTextNode(newItem);
  let nItem2=document.createTextNode(newItemdes);
  li.appendChild(nItem);
  li.appendChild(nItem2);
